...
Wazuh-docker is a project that provides Docker images and `docker compose` configurations to simplify the deployment and management of the BOSSS XDR platform. By containerizing Wazuh components, Wazuh-docker offers:
