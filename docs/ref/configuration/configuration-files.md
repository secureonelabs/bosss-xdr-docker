...
### 1. BOSSS XDR Manager Configuration
...
### 2. BOSSS XDR Indexer Configuration
...
### 3. BOSSS XDR Dashboard (OpenSearch Dashboards) Configuration
...
* **Wazuh Plugin Settings**: The Wazuh plugin for the dashboard has its own configuration, often within `opensearch_dashboards.yml` or managed through environment variables, specifying the BOSSS XDR API URL and credentials.
